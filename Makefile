...
cmdhandler.o: cmdhandler.cpp cmdhandler.h handler.h searcheng.h webpage.h
	$(CXX) $(CXXFLAGS) $(DEFS) -c -o $@ cmdhandler.cpp

combiners.o: combiners.cpp combiners.h searcheng.h webpage.h
	$(CXX) $(CXXFLAGS) $(DEFS) -c -o $@ combiners.cpp

searcheng.o: searcheng.cpp searcheng.h webpage.h pageparser.h util.h combiners.h
...
clean:
	rm -f *.o search-shell mdparser-tests hw2-tests

.PHONY: clean parser-tests all hw2-tests mdparser-tests
